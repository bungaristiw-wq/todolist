...
<body class="bg-pink-100 min-h-screen flex justify-center items-center">
    ...
    <div class="bg-white w-96 p-8 rounded-2xl shadow-xl">
        <h1 class="text-2xl font-bold text-center text-pink-600 mb-6">Buat List</h1>
        ...
        <form method="POST" action="{{ route('todolist.store') }}">
            ...
            <textarea name="description"
                      class="w-full px-3 py-2 border rounded-lg mt-1 mb-4 focus:ring-2 focus:ring-pink-300"></textarea>
